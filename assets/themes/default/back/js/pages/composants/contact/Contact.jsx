...
export class Contact extends Component {
    ...
    handleUpdateSeen = (id) => {
        let self = this
        axios({ method: 'post', url: Routing.generate('admin_contact_update_seen', {'contact': id}) }).then(function (response) {
    ...
    handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.value) {
                ...
                let self = this
                axios({ method: 'post', url: Routing.generate('admin_contact_delete', {'contact': id}) }).then(function (response) {
